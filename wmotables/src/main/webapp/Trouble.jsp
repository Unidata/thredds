...
<p>For example (ISXAB40KWNO.bufr):<br />
  <br />
...
   
  0-19-3: Wind_SPD_threshold units=m s-1 scale=0 refVal=0 nbits=8 <br />
   
0-19-9: Effective_radius_with_respect_to_wind_speeds_above_threshold units=m scale=-3 refVal=0 nbits=12 </p>
<p><strong>7.2. associated variables seem like a kludge</strong><br />
  <br />
 
6 bits of meaning for 1 bit of data. example of (9) </p>
<h3><strong>8. lack of name/value attributes </strong></h3>
...
<h3><strong>  9. multiple fields with same name </strong></h3>

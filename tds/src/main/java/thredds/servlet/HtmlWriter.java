 ...
 * <li>Catalog reference URL: "/thredds/catalogServices?catalog="</li>
  ...
  */
  ...
  public void writeDirectory(HttpServletResponse res, File dir, String path)
    ...
    log.info( UsageLog.accessInfo(HttpServletResponse.SC_OK, dirHtmlString.length()));
  }
  ...
  public void writeCatalog(HttpServletResponse res, InvCatalogImpl cat, boolean isLocalCatalog)
    ...
    log.info( UsageLog.accessInfo( HttpServletResponse.SC_OK, catHtmlAsString.length()));
  }
          ...
          throws IOException
  {
    ...
    log.info( UsageLog.accessInfo( HttpServletResponse.SC_OK, datasetAsHtml.length() ));
  }
  ...
  public void showCDM(HttpServletResponse res, NetcdfDataset ds)
    ...
    log.info( UsageLog.accessInfo(HttpServletResponse.SC_OK, cdmAsString.length()));

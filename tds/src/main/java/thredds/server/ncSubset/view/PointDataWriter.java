...
interface PointDataWriter {
	...
	boolean header(List<String> vars, GridDataset gridDataset, List<CalendarDate> wDates, LatLonPoint point, CoordinateAxis1D zAxis);
	
	boolean header(List<String> vars, GridDataset gridDataset, List<CalendarDate> wDates, LatLonPoint point);

...
/* $Id: DODSServlet.java 51 2006-07-12 17:13:13Z caron $
*
*/
 ...
 * @see #processDodsURL(HttpServletRequest,HttpServletResponse)
 */
...
//        System.out.println("Returning CE: \""+ce+"\"");
  ...
  protected ReqState processDodsURL(HttpServletRequest request, HttpServletResponse response) throws BadURLException {
...
//            }
      ...
      if (rs != null) {
        ...
        if (dataSet.equalsIgnoreCase("version") || dataSet.equalsIgnoreCase("/version") || dataSet.equalsIgnoreCase("/version/")) {

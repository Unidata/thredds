								...
								<td class="rightCol">
									...
									<div class="borderLightGrey">
										...
										<div class="top">
											<span>north</span>
											<br />
											<input disabled="disabled" type="text" name="north"
												size="8" value="{gridForm/LatLonBox/north}" />
										</div>
										<div>
											west
											<input disabled="disabled" type="text" name="west"
												size="8" value="{gridForm/LatLonBox/west}" />
											<input disabled="disabled" type="text" name="east"
												size="8" value="{gridForm/LatLonBox/east}" />
											east
										</div>
										<div class="top">
											<input disabled="disabled" type="text" name="south"
												size="8" value="{gridForm/LatLonBox/south}" />
											<br />
											<span>south</span>
										</div>
									</div>

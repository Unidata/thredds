// $Id: ContourFeature.java,v 1.1 2004/09/30 00:33:42 caron Exp $
/*
 ...
 *
 * @author Stuart Wier
 * @version $Id: ContourFeature.java,v 1.1 2004/09/30 00:33:42 caron Exp $
 */
...
public class ContourFeature extends thredds.datamodel.gis.AbstractGisFeature {
  ...
  private double contourValue;
    ...
    public double getContourValue() {
        ...
        public java.util.Iterator getGisParts() { return lines.iterator(); }

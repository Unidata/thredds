 ...
 *
 * <p>
 * If it's a {@code StationObsDataset}, the available {@code Station}s are shown in a {@code BeanTable}.
 * The obs are shown in a {@code StructureTable}.
 * </p>
 *
 * @author caron
 */
    ...
    /** */
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (!pfDataset.getFeatureType().equals(FeatureType.STATION)) {
                ...
                final Object message = "Currently, only the STATION feature type is supported, not " + pfDataset.getFeatureType();

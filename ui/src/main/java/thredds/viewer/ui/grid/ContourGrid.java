// $Id: ContourGrid.java,v 1.3 2004/09/30 00:33:40 caron Exp $
/*
 ...
 *
 * @author Stuart Wier
 * @version  $Id: ContourGrid.java,v 1.3 2004/09/30 00:33:40 caron Exp $
 *
...
public class ContourGrid  {
   ...
   switch (startSide) // switch on incoming cell edge
      ...
      default:  System.out.println("Impossible direction "+startSide+
...
/* Change History:
    ...
    *** empty log message ***
    ...
    Revision 1.30  2001/05/10 17:27:21  wier
    fixed bug in contouring near missing values; improved comments and javadoc

    Revision 1.29  2001/03/09 19:36:19  caron
    missing data bugs

    Revision 1.28  2001/02/21 21:31:00  caron
    nissing data

    Revision 1.27  2000/08/18 04:16:25  russ
    Licensed under GNU LGPL.

    Revision 1.26  2000/06/30 16:31:19  caron
    minor revs for GDV release

    Revision 1.25  2000/05/25 21:00:44  wier
    simplified since using new ContourFeature

    Revision 1.24  2000/05/23 22:02:24  wier
    Correct bug in contouring near missing data

    Revision 1.23  2000/05/16 19:07:55  caron
    fix bug

    Revision 1.22  2000/05/16 16:54:55  wier

    public method getContourLines() now returns an ArrayList of
    ContourFeatures; inner class ConLineFeature now implements ContourFeature.

    Revision 1.21  2000/05/15 17:24:27  wier
    fixed bug in contouring at saddle point

    Revision 1.20  2000/05/12 23:22:36  wier
    improve contours near missing data

    Revision 1.19  2000/05/10 20:46:00  wier
    put grid data in an Array so can use short, float, etc.

    Revision 1.18  2000/05/09 20:43:07  caron
    change deprecated Format method

    Revision 1.17  2000/02/16 23:37:17  wier
    Fixed final(?) broken contours along edges

    Revision 1.16  2000/02/16 18:27:09  wier
    Fixed broken contours along top edge

    Revision 1.15  2000/02/16 17:36:07  wier
    debug contourTiming message added

    Revision 1.14  2000/02/15 22:47:33  wier
    recode for speed: time cut to 36% of former

    Revision 1.13  2000/02/15 21:14:46  wier
    include divide by zero trap

    Revision 1.12  2000/02/14 23:43:49  wier
    fix array out of bounds

    Revision 1.11  2000/02/14 23:08:22  wier
    fix some gaps in lines

    Revision 1.10  2000/02/11 22:44:57  wier
    get copyto1DJava working; much faster now about 1.5 sec

    Revision 1.9  2000/02/11 21:19:15  wier
    reduce numer array access; add copyto1DJava

    Revision 1.8  2000/02/11 18:00:48  wier
    clean up code; fix some gaps in contours

    Revision 1.7  2000/02/11 00:54:46  wier
    fixed lack of new in position

    Revision 1.6  2000/02/10 23:05:01  wier
    changes to match new ContourLine class

    Revision 1.5  2000/02/10 21:46:35  wier
    fixed known exception

    Revision 1.4  2000/02/10 15:33:58  wier
    added boolean to cstr for missing data flag

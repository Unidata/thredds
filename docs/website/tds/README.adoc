...
2.  The <<../netcdf-java/documentation#,Netcdf-Java/CDM library>>
...
3.  TDS can use the <<../netcdf-java/ncml/index#,NetCDF Markup Language>>
(NcML) to modify and create virtual aggregations of CDM datasets.
...
8.  The integrated <<reference/services/ncISO#,ncISO server>> provides

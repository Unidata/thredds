...
* The CDM data model is clarified to allow vlen dimensions only in the innermost (fastest changing) Dimension.
* Reading a Variable with only a vlen Dimension will result in a regular Array.

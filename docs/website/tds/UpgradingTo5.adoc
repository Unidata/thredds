...
* For new API see <<../netcdf-java/reference/FeatureDatasets/CoverageFeatures.adoc,CoverageFeatures>>
...
* DatasetScan details are <<catalog/InvCatalogServerSpec.adoc,here>>
...
* Standard service details are <<reference/Services.adoc,here>>
...
-----------------------------------------------------------
* Feature Collection details are <<reference/collections/FeatureCollections.adoc,here>>
...
<<reference/services/NetcdfSubsetServiceReference.adoc,NCSS Reference>> for details.
...
<<reference/RemoteManagement.adoc,Remote Management>>, and from **https://server/thredds/admin/debug**, select __"Make Catalog Report"__. This may

...
link:tutorial/CatalogPrimer.adoc#Constructing_an_access_URL[tutorial]
and the link:catalog/InvCatalogSpec.adoc#constructingURLs[catalog spec]
...
link:./reference/ThreddsConfigXMLFile.adoc#opendap[OPeNDAP section] of
...
it in the
link:reference/ThreddsConfigXMLFile.adoc#AggregationCache[threddsConfig.xml]
...
available link:reference/DirectoryLocations.adoc[here].
______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
...
this, eg in link:reference/ChecklistReference.adoc[setenv.sh], this sets
the heap to 4 GB.
...
link:reference/ChecklistReference.adoc[setenv.sh]:
...
link:./reference/Performance.adoc#robots[these directions].
______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________

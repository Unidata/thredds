...
link:ThreddsConfigXMLFile.adoc#FileCache[TDS configuration values], this
...
link:ThreddsConfigXMLFile.adoc#FileCache[threddsConfig.xml] file.
...
link:collections/FeatureCollections.adoc[collections], this can take
hours or even days. By indexing GRIB files before they are accessed with
the link:collections/TDM.adoc[TDM], users get much faster response time.

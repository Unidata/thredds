...
http://www.oracle.com/technetwork/java/javase/javawebstart/index.html[Java Webstart]). For
...
If you don't specify the <argument>, ToolsUI will still startup normally,
...
https://www.unidata.ucar.edu/software/thredds/current/netcdf-java/webstart/netCDFtools.jnlp

...
. Define the roles
link:../tutorial/GettingStarted.adoc#grantingAccess[manager-gui],
link:../tutorial/examples/accessingTDSMonitoringAndDebuggingTools.adoc[tdsConfig] and (optionally)
...
.  Make sure the manager is only link:../tutorial/examples/tomcatManagerSSL.adoc[available via SSL] by
...
5. link:../tutorial/Security.adoc#unused[Remove any unused applications]

...
(<<../faq.adoc#javaUtilPrefs,details>>). +
...
<<../tutorial/examples/accessingTDSMonitoringAndDebuggingTools.adoc,tdsConfig>> and (optionally)
<<../tutorial/examples/accessingTDSMonitoringAndDebuggingTools.adoc,tdsMonitor>>.
...
.  Make sure the manager is only <<../tutorial/examples/tomcatManagerSSL.adoc,available via SSL>> by
...
* <<../tutorial/AddingServices.adoc,Enable any other optional services>> like WMS or WCS.

...
* <<#available,List of all TDS Services>>
** <<#serverInfo,Server Information Services>>
** <<#catalogServices,Catalog Services>>
** <<#metadataServices,Metadata Services>>
*** <<#ISO,ISO>>
*** <<#NCML,NCML>>
*** <<#UDDC,UDDC>>
** <<#dataAccessServices,Data Access Services>>
*** <<#DAP2,OPeNDAP DAP 2.0>>
*** <<#WCS,OGC WCS>>
*** <<#WMS,OGC WMS>>
*** <<#NCSS,NCSS>>
*** <<#cdmremote,CDMRemote>>
*** <<#HTTP,HTTP File Download>>
* <<#tdsServiceElemRequirements,TDS Requirements for THREDDS Catalog service Elements>>
...
<<#tdsServiceElemRequirements,more details>>.)
...
<<#compoundExample,below>>) which adds all the nested services to the
dataset.
...
* More details are available <<CatalogService.adoc,here>>.
...
Catalog Service Configuration +
 (exact values <<#tdsServiceElemRequirements,required>>)
...
* More details are available <<ncISO.adoc,here>>.
...
<<NetcdfSubsetServiceReference.adoc,here>>.
...
<<NetcdfSubsetServiceConfigure.adoc,here>>.
...
* More details are available
<<../../netcdf-java/reference/stream/CdmRemote.adoc,here>>.
...
implementation are available <<WCS.adoc,here>>.
...
implementation are available <<WMS.adoc,here>>. Including a link to

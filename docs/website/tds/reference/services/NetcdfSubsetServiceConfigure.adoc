...
link:../../netcdf-java/CDM/index.adoc[CDM]-compatible datasets through
...
link:NetcdfSubsetServiceReference.adoc[NetCDF Subset Service Reference].
...
the link:ThreddsConfigXMLFile.adoc#ncss[threddsConfig.xml] docs.

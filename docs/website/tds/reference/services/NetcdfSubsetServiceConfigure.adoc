...
<<../../netcdf-java/CDM/index.adoc,CDM>>-compatible datasets through
NCSS, but right now there are some <<#restrictions,restrictions>> on
...
<<NetcdfSubsetServiceReference.adoc,NetCDF Subset Service Reference>>.

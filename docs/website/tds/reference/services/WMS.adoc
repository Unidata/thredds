...
<<../faq#wmsLimitedCRS,this FAQ entry>>.
...
http://www.oracle.com/technetwork/articles/javase/headless-136834.html[here].
...
<<../faq#javaUtilPrefs,TDS FAQ page>>.

...
link:../../../netcdf-java/ncml/FmrcAggregation.html[FMRC Aggregation]
...
You can pass it a link:CollectionSpecification.html[collection
...
1.  link:CollectionSpecification.html[collection specification] string

...
See link:../catalog/InvCatalogServerSpec.adoc#datasetScan[Server Catalog Spec] for formal definition of the XML.
...
link:../catalog/InvCatalogServerSpec.adoc[server catalog spec] for

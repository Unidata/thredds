...
See <<../catalog/InvCatalogServerSpec.adoc#datasetScan,Server Catalog Spec>> for formal definition of the XML.
...
link:../catalog/InvCatalogSpec.adoc#constructingURLs[THREDDS URL
...
[<<#sample1,Sample config catalog 1]>> +
...
<<../catalog/InvCatalogServerSpec.adoc,server catalog spec>> for
...
[<<#sample2,Sample config catalog 2]>>
...
[<<#sample3,Sample config catalog 3]>>
...
Also see
link:../catalog/InvCatalogServerSpec.adoc#addProxies_Element[Server-side

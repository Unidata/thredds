...
* link:../reference/collections/CollectionSpecification.adoc[Collection
specification]
...
link:../reference/collections/FmrcCollection.adoc#fmrcConfig[here], as
...
link:../reference/collections/FeatureCollections.adoc#dateExtractor[here]
for more details.
...
link:../reference/collections/FeatureCollections.adoc[reference doc].

...
<<../reference/collections/FmrcCollection.adoc#fmrcConfig,here>>, as
...
<<../reference/collections/FeatureCollections.adoc#dateExtractor,here>>
for more details.
...
<<../reference/collections/FeatureCollections.adoc,reference doc>>.

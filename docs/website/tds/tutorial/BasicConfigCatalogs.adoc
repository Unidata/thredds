...
install directory. See the link:../reference/DirectoryLocations.adoc[TDS
...
link:../reference/ThreddsConfigXMLFile.adoc[here]).
** `logs/`
...
link:CatalogPrimer.adoc[Client catalogs] with extensions. They contain

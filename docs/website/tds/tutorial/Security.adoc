...
You should know how to do a link:GettingStarted.adoc[basic installation]
of Tomcat, Java, and the TDS; and be familiar with the
link:GettingStarted.adoc#tour[Tomcat directory structure];
link:GettingStarted.adoc#files[Tomcat server configuration]; and the
...
Tool], and the link:tdsMonitor.adoc[TdsMonitor Tool] – both of which
...
and the link:tdsMonitor.adoc[TdsMonitor Tool]._

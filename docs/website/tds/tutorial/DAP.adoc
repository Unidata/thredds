...
* <<#TDSClientServer,TDS as Client-Server>>
* <<#Opendap,What are OPenDAP and DAP>>
* <<#URLS,Specifying a DAP Data Source>>
* <<#Exercise1,Exercise: Examine A Dataset in Three Ways>>
* <<#Response,Components of a DAP Response>>
* link:#Exercise2[Exercise: Examine The Components of DAP2 and DAP4
Responses]
* <<#DAP2Constraints,DAP2 Constraints>>
* <<#DAP4Constraints,DAP4 Constraints>>

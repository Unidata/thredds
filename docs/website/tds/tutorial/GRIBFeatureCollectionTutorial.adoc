...
* link:../reference/collections/GribCollections.adoc[GRIB Collection
Reference]
...
Download <<files/catalogGribfc.xml,catalogGribfc.xml>>, place it in
...
<<files/catalogGribfc.xml,catalogGribfc.xml>> has:

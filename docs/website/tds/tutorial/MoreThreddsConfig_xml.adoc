...
Services]
* <<../reference/Services.adoc#catalogServices,Catalog Services>>
* <<../reference/Services.adoc#metadataServices,Metadata Services>>
* link:../reference/Services.adoc#dataAccessServices[Data Access
Services]

Let’s try it out. A quick <<AddingServices.adoc,exercise>>.
...
<<../reference/ThreddsConfigXMLFile.adoc#netcdfCLibrary,here>>.
...
Various methods are described <<../reference/Viewers.adoc,here>>
including <<../reference/ThreddsConfigXMLFile.adoc#Viewers,one>> that

 ...
 * link:http://www.unidata.ucar.edu/software/tds/v4.6/tutorial/BasicThreddsConfig_xml.html[Exercise]:
 ...
 *** link:http://www.unidata.ucar.edu/software/netcdf-java/v4.6/documentation.htm[netCDF-Java] (and thus the TDS)

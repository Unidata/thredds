 ...
 * link:/tds/4.6/adminguide/tutorial/BasicThreddsConfig_xml.html[Exercise]:
...
** /tds/5.0/adminguide/upgrading.html[Details]
 ...
 *** link:https://www.unidata.ucar.edu/netcdf-java/4.6/userguide/documentation.htm[netCDF-Java] (and thus the TDS)

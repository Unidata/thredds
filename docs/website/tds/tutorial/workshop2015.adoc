 ...
 * link:https://www.unidata.ucar.edu/community/surveys/2015training/survey.html[Feedback/Evaluation
 ...
 * link:https://www.unidata.ucar.edu/software/tds/v4.6/tutorial/BasicThreddsConfig_xml.html[Exercise]:
 ...
 * Issue Tracking with https://www.unidata.ucar.edu/jira/[JIRA]
 * https://www.unidata.ucar.edu/support/#mailinglists[Email Lists]: thredds@unidata.ucar.edu; netcdf-java@unidata.ucar.edu
 * https://www.unidata.ucar.edu/support/index.html#archives[Support]: support-thredds@unidata.ucar.edu; support-netcdf-java@unidata.ucar.edu
...
** https://www.unidata.ucar.edu/software/thredds/v5.0/tds/UpgradingTo5.html[Details]
 ...
 * link:https://doi.org/10.5065/vkan-dp10[On the suitability of BUFR and GRIB for archiving data] (link:https://www.unidata.ucar.edu/blogs/developer/en/entry/on_the_suitability_of_grib[tl;dr;])
 ...
 *** link:https://www.unidata.ucar.edu/software/netcdf-java/v4.6/documentation.htm[netCDF-Java] (and thus the TDS)

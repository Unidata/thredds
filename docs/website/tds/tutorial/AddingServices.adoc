...
To enable the <<../reference/WCS.adoc,WCS service>> for locally served
...
To enable the <<../reference/WMS.adoc,WMS service>> for locally served
datasets, you will need the following in your `threddsConfig.xml` file:
...
To enable the <<../reference/ncISO.adoc,ncISO services>> for locally
...
<<images/Godiva2_screenshot.png[image:images/Godiva2_screenshot_small.png,Godiva2]>>

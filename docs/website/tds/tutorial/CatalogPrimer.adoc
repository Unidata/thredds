...
* <<#Constructing_an_access_URL,Constructing an access URL>>
* <<#Nested_datasets,Nested datasets>>
* <<#Describing_datasets,Describing datasets>>
* <<#Sharing_metadata,Sharing metadata>>
* <<#Catalog_references,Catalog references>>
* <<#Compound_service_elements,Compound `service` elements>>
* <<#XML_validation,XML validation>>
* <<#Using_ToolsUI,Using ToolsUI to view catalogs>>
...
<<images/TUIthreddsTab.png[image:images/TUIthreddsTab.png,ToolsUI]>>

...
The link:../catalog/InvCatalogSpec.adoc[catalog specification] is the
...
link:../catalog/InvCatalogSpec.adoc#dataset[catalog specification].
...
link:../reference/DLexport.adoc[here].
...
link:../catalog/InvCatalogSpec.adoc#serviceTypes[catalog specification].
...
link:../catalog/InvCatalogSpec.adoc[catalog specification] instead, as

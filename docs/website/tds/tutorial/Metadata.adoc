...
link:../reference/DatasetScan.html[here] for a full description of the
datasetScan element.
...
link:../reference/DatasetScan.html#addTimeCoverage[here] for the gory
...
* link:../catalog/InvCatalogSpec.html[THREDDS Catalog specification] -
link:../catalog/InvCatalogSpec.html#threddsMetadataGroup[Metadata
Section]

...
link:../reference/DatasetScan.adoc[here] for a full description of the
datasetScan element.
...
link:../reference/DatasetScan.adoc#addTimeCoverage[here] for the gory
...
* link:../catalog/InvCatalogSpec.adoc[THREDDS Catalog specification] -

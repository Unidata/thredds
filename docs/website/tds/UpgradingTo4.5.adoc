...
<<reference/collections/GribCollections.adoc,GRIB Collections>> and
<<reference/collections/TDM.adoc,TDM>>.
...
change them, see the
<<reference/NetcdfSubsetServiceReference.adoc,NCSS REST API>>. (If you
...
* link:../netcdf-java/reference/netcdf4Clibrary.adoc#writing[Netcdf-4

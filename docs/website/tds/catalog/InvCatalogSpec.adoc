...
* Catalog link:../tutorial/CatalogPrimer.adoc[Primer]
...
* link:../reference/DigitalLibraries.adoc[Writing metadata for Digital Libraries]

* Java API to read catalogs in the http://www.unidata.ucar.edu/software/netcdf-java/[netCDF-Java library].

* link:Changes.adoc[Changes] since version 1.0.1.

* link:InvCatalogServerSpec.adoc[Server-side catalog specification]
...
more _link:#service[service]_ elements, followed by zero or more _link:#property[property]_ elements,
...
typically one of the _link:#serviceTypes[serviceType]_ values.

...
* <<Paths#catalogService,CatalogServicesServlet>>:
_/catalogServices/*, /catalog.html_
* <<Paths#catalog,CatalogServlet>>: _/catalog/*_
* <<Paths#cdmValidate,CoordSysValidatorServlet>>: _/cdmValidate_
* <<Paths#DLWriter,DLwriterServlet>>: _/DLwriter_
* DqcServlet: _/dqc/*_
* <<Paths#FileServer,FileServerServlet>>: _/fileServer/*_
* <<Paths#modelInventory,FmrcInventoryServlet>>__:
/modelInventory/*__
* MetarServlet: _/idd/metar/*_
* <<Paths#dodsC,NcDODSServlet>>: _/dodsC/*_
* <<Paths#ncss,NetcdfServlet>>: _/ncss/grid/*_
* StationObsCollectionServlet: _/obsServer/*_
* ThreddsDefaultServlet__: everything else__
* <<Paths#view,ViewServlet>>__: /view/*__
* <<Paths#wcs,WCSServlet>>: _/wcs/*_

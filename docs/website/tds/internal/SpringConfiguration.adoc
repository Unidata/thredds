...
(link:../../netcdf-java/reference/stream/CdmRemote.adoc[ref]) | 
|ResponseEntity<String>, void

|CdmrGridController |*/cdmrfeature/grid* |/\{path}?\{cdmrf query}
(link:../../netcdf-java/reference/stream/CdmrFeature.adoc[ref]) |  | 
...
(link:../reference/services/NetcdfSubsetServiceReference.adoc[ref]) +
 **/dataset.[html|xml]  +

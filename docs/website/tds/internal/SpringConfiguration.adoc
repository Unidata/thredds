...
(<<../../netcdf-java/reference/stream/CdmRemote.adoc,ref>>) | 
|ResponseEntity<String>, void

|CdmrGridController |*/cdmrfeature/grid* |/\{path}?\{cdmrf query}
(<<../../netcdf-java/reference/stream/CdmrFeature.adoc,ref>>) |  | 
...
(<<../reference/services/NetcdfSubsetServiceReference.adoc,ref>>) +
 **/dataset.[html|xml]  +

...
in a
link:../../../../archive/src/docs/web/thredds/tech/TDS.adoc#Catalogs[THREDDS
...
Typically the user wants a <<#subset,subset>> of the dataset.This is
...
A desired _<<#representation,representation>>_ of the resource is

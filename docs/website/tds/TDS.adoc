...
.  An optional link:reference/services/ncISO.adoc[ncISO server] provides
...
link:reference/services/CdmrFeature.adoc[CDM Remote Feature Service]
...
* link:reference/services/CdmRemote.adoc[Cdmremote and CdmrFeature web services]

...
subsets can be returned in CSV, XML, or {cf}#discrete-sampling-geometries[CF-DSG]
netCDF files.
10. The integrated
...
** link:tutorial/Checklist.adoc[Checklist for Production Installation]
...
** link:tutorial/index.adoc[Tutorial]
** link:faq.adoc[FAQ]
** link:UpgradingTo4.6.adoc[Upgrading to TDS 4.6]
** link:tutorial/Checklist.adoc[Checklist for Production Installation]

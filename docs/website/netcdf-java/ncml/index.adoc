...
* <<Aggregation.adoc,Aggregation>>
* <<Cookbook.adoc,Cookbook Examples>>
* <<AnnotatedSchema4.adoc,Annotated Schema for Netcdf-Java 4>>
...
*_NcML Core Schema_* and *_NcML Dataset_* have now been combined into a single _<<AnnotatedSchema4.adoc,NcML Schema>>_

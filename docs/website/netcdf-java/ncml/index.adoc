...
3.  Use the NetCDF-Java library link:../reference/manPages.adoc#ncdump[ncdump application], eg:
+
-------------------------------------------------------------------------
...
in this link:Tutorial.adoc#modify[example].
.  Write the new file as a netCDF-3 format file:
..  Use the NetCDF-Java library link:../reference/manPages.adoc#nccopy[nccopy application] to write the new file, eg:
+
------------------------------------------------------------------------------------------------------
...
* link:Aggregation.adoc[Aggregation]
* link:Cookbook.adoc[Cookbook Examples]
* link:AnnotatedSchema4.adoc[Annotated Schema for Netcdf-Java 4]
...
*_NcML Core Schema_* and *_NcML Dataset_* have now been combined into a single _link:AnnotatedSchema4.adoc[NcML Schema]_

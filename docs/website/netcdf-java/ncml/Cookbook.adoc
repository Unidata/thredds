...
link:../reference/Cookbook.adoc#writeClassic[command line copy]. One can
...
Create union of all datasets ending in _mean.nc_ located in the directory _nc_ reletive to where the NcML file is found:
...
See link:../reference/DatasetUrls.adoc#NcmlScan[Dataset URLS] for more information on the location attribute.
...
link:Aggregation.adoc#dateFormatMark[dateFormatMark] attribute. +

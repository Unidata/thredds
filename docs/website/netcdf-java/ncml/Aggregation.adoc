...
4.  link:FmrcAggregation.html[*ForecastModelRunCollection*] (FMRC): A
...
the
link:../reference/CoordinateAttributes.html#CoordinateAttributes[Coordinate
...
link:AnnotatedSchema4.html#SimpleDateFormat[*java.text.SimpleDateFormat*]

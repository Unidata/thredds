...
Download <<examples/example1.nc,example1.nc>> and
<<examples/exercise1.ncml,exercise1.ncml>> and place them in the same
...
Download <<examples/exercise3.ncml,exercise3.ncml>> and place it in
...
Next: <<Aggregation.adoc,Aggregation>>

...
Adding link:../CDM/index.html[Coordinate System] information is the
...
is to use the CDM link:CoordinateAttributes.html[_Coordinate Attribute
...
link:CoordSysBuilder.html[_CoordSysBuilder_] object, and Coordinate

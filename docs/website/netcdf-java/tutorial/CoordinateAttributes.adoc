...
1.  <<#Example1,Example 1>>: Simple Coordinate Variables
2.  <<#Example2,Example 2>>: Coordinate System Variable
3.  <<#Example3,Example 3>>: Multiple Coordinate Systems
4.  <<#Example4,Example 4>>: Adding Coordinate Transforms
5.  <<#Example5,Example 5>>: Reusing Variables for Coordinate System
and/or Coordinate Transform Variables
6.  <<#Implicit,Implicit>> Coordinate Systems
7.  <<#CoordinateTransformVariables,Coordinate Transform Variables>>

...
For more details, see the <<../CDM/index.adoc,CDM Object Model>>.
...
<<../reference/CoordinateAttributes.adoc,here>>) to create Coordinate
...
can also <<CoordTransBuilder.adoc,write your own implementation>> and

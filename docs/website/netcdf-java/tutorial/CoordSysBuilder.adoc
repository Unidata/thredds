...
For more details, see the link:../CDM/index.adoc[CDM Object Model].
...
link:../reference/CoordinateAttributes.adoc[here]) to create Coordinate
...
can also link:CoordTransBuilder.adoc[write your own implementation] and

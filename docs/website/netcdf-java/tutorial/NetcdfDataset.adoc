...
* Opens a link:../reference/stream/CdmRemote.html[CdmRemote] dataset, if
...
link:NetcdfFile.html#HTTP[HTTP access] to any CDM file.
...
link:CoordSysBuilder.html[here]. To see the list of CoordinateBuilder

...
dataset, you can use the link:../reference/manPages.adoc#nccopy[CDM
nccopy application]. By combining nccopy and NcML, you can copy just
parts of an existing dataset, as well as
<<../ncml/index.htm#modify,make modifications to it with NcML>>.

Writing netCDF-4 files requires that you
<<../reference/netcdf4Clibrary.adoc,install the netCDF-4 C library>>
on your machine.
...
See <<../reference/netcdf4Clibrary.adoc#writing,here>> for more

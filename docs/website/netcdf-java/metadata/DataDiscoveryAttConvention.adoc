...
The link:../../tds/catalog/InvCatalogServerSpec.adoc[THREDDS data type]
...
link:DataDiscoveryAttConvention.adoc#license_Attribute[license]
...
|=======================================================================
|Attribute |Description |THREDDS
|link:DataDiscoveryAttConvention.adoc#date_available_Attribute[date_available] +
...
|link:DataDiscoveryAttConvention.adoc#date_valid_Attribute[date_valid]

...
link:DataDiscoveryAttConvention.html#summary_Attribute[summary] +

More general than a summary. +

 +

link:DataDiscoveryAttConvention.html#acknowledgement_Attribute[acknowledgement] +

I don’t see a place for this in CF. Maybe comment. +

http://www.cgd.ucar.edu/cms/eaton/cf-metadata/CF-1.0.html#des[history] +

link:DataDiscoveryAttConvention.html#history_Attribute[history] +
...
link:DataDiscoveryAttConvention.html#creator_name_Attribute[creator_name] +
 creator_url +
 creator_email +
...
link:DataDiscoveryAttConvention.html#contributor_name_Attribute[contributor_name] +
 contributor_role

Another possible mapping (contributor can also be individual or
institution). +

link:DataDiscoveryAttConvention.html#id_Attribute[id] +
 naming_authority +
...
link:DataDiscoveryAttConvention.html#project_Attribute[project] +
...
link:DataDiscoveryAttConvention.html#processing_level_Attribute[processing_level] +
...
link:DataDiscoveryAttConvention.html#standard_name_Attribute[standard_name] +
...
link:DataDiscoveryAttConvention.html#standard_name_vocabulary_Attribute[standard_name_vocabulary]
...
link:DataDiscoveryAttConvention.html#title_Attribute[title] +

Direct mapping between CF and this proposal. +

 +

link:DataDiscoveryAttConvention.html#time_coverage_start_Attribute[time_coverage_*] +

link:DataDiscoveryAttConvention.html#geospatial_lat_min_Attribute[geospatial_*]

...
1.  The *_<<#dataAccess,data access layer>>_*, also know as the
*_syntactic layer,_* handles data reading and writing.
2.  The *_<<#CoordSys,coordinate system>>_* layer identifies the
...
3.  The *_<<#ScientificFeatureTypes,scientific feature type>>_* layer
...
* CDM Feature Types _draft_ <<CDMfeatures.doc,doc>>
* CDM Point Feature Types _draft_ <<CDMpoints.doc,doc>>

...
The link:CoordinateAttributes.adoc#AxisTypes[*_AxisType_*] enumerations are specific to the case of georeferencing
...
Also see: link:CoordinateAttributes.adoc#CoordSysBuilder[Coordinate System Building].

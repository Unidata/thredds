...
.  **Shared Dimensions**: All dimensions used by a Coordinate Axis must
...
CoordinateAxis with a *_coordinate variable_*, which is a Variable
...
* CF Discrete Sampling Geometries Conventions http://cfconventions.org/Data/cf-conventions/cf-conventions-1.6/build/cf-conventions.html#discrete-sampling-geometries

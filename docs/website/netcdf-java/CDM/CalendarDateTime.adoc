...
1.  *<<#udunit,udunit coordinate>>:* Variables of any numeric type
...
2.  *<<#calendar_field,calendar field coordinate>>:* Variables of any
...
3.  *<<#ISO_String,ISO String coordinate>>:* Variables of type

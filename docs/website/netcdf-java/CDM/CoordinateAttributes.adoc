...
* <<../tutorial/CoordinateAttributes.adoc,Tutorial Examples>>
...
The attribute value must be one of the valid <<#AxisTypes,Axis Types>>, for example:
...
The attribute value must be a list of the valid <<#AxisTypes,Axis Types>>, for example:
...
The Netcdf-Java library has a <<StandardCoordinateTransforms.adoc,set of transforms that it recognizes>>, mostly based on the CF Conventions.

...
library implements the link:CDM/index.adoc[Common Data Model] (CDM) to
...
View *link:/support/help/MailArchives/netcdf/maillist.adoc[Current
...
link:/events/index.adoc#training[training workshop] at the
link:/about/index.adoc#visit[UPC] in Boulder
...
* link:reference/Cookbook.adoc[image:/software/img/cookbook-32x32.png[Cookbook]]
Use the netCDF Java link:reference/Cookbook.adoc[cookbook] for common
examples
...
* link:v4.3/javadoc/index.adoc[image:/img/v3/logos/java-32x32.png[Javadocs]]Unidata
NetCDF Java +
 *link:v4.3/javadoc/index.adoc[Javadoc API]*
* link:CDM/index.adoc[image:/software/img/build-32x32.png[NetCDF Java
Architecture]]**link:CDM/index.adoc[CDM Architecture]** +
 for developers
...
===== link:/projects/index.adoc#cdm[Common Data Model]
...
link:index.adoc#formats[file formats] besides netCDF.

link:/projects/index.adoc#cdm[More about the CDM]

...
be any link:formats/FileTypes.html[CDM dataset], including OPeNDAP URLs,
...
link:netcdf4Clibrary.html[netcdf-4 C library loaded].
...
Copies a CDM link:FeatureDatasets/PointFeatures.html[point feature
dataset] to
...
mode]. For that, you must first install the link:netcdf4Clibrary.html[C
library].
...
link:../../tds/reference/collections/FeatureCollections.html[<featureCollection>].

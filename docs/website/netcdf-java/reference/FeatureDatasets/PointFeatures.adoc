...
* link:CFencodingTable.adoc[CDM Nested Table encoding]
...
The actual data of the observation is contained in a **link:../StructureData.adoc#StructureData[ucar.ma2.StructureData]**, which has a collection of

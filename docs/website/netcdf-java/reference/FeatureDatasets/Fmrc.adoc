...
An FMRC *featureCollection* supersedes using NcML <<../../ncml/FmrcAggregation.adoc,FMRC Aggregation>>.
In the TDS, one uses a <<../../../tds/reference/collections/FeatureCollections.adoc,FMRC FeatureCollection>> element.
...
<<../../../tds/reference/collections/FeatureCollections.adoc,CollectionManager>>.
...
* <<../../../tds/reference/collections/FeatureCollections.adoc,Configuring TDS with the FeatureCollection element>>

...
An FMRC *featureCollection* supersedes using NcML link:../../ncml/FmrcAggregation.html[FMRC Aggregation].
In the TDS, one uses a link:../../../tds/reference/collections/FeatureCollections.html[FMRC FeatureCollection] element.
...
* link:../../../tds/reference/collections/FeatureCollections.html[Configuring TDS with the FeatureCollection element]

...
<2> Get the link:CdmrfGrammer.adoc#header[CdmrFeature Header].
...
<5> Variable names are case-sensitive and must be link:../../CDM/Identifiers.adoc#cdmremote[backslash-escaped]

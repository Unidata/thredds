...
1.  Use <<../RuntimeLoading.adoc,Runtime Loading>> to add your own
...
<<#DefineGrib1Params,XML Schema for declaring Grib-1 Parameters>>.
...
You can reference a <<#tableMap,table map>> in NcML by passing the
...
<<#DefineGrib1Params,standard XML schema>>) in a featureCollection

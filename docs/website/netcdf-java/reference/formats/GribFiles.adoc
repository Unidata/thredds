...
link:../netcdf4Clibrary.adoc[write to netCDF-4] format, with file sizes
...
The CDM has a link:GribTables.adoc[number of ways] to allow you to use
...
link:GribTables.adoc[improve methods for writing GRIB]and maintaining
local tables.
...
You can use a link:../manPages.adoc#GribCdmIndex[command line tool] that
uses a complete

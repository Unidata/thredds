...
link:../../tds/reference/ThreddsConfigXMLFile.html#netcdfCLibrary[THREDDS
configuration file].
...
link:RuntimeLoading.html#XML[runtime configuration file]
** directly call
...
* From the command line: see link:manPages.html#nccopy[nccopy man page]

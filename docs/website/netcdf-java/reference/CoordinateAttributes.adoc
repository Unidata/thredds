...
For an overview, see: link:../CDM/index.html[CDM Object Model]. The
...
link:../tutorial/CoordinateAttributes.html#Example4[Example] and
link:CoordinateAttributes.html[Reference]). The attributes of the
...
link:StandardCoordinateTransforms.html[set of transforms that it

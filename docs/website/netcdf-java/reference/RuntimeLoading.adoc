...
5.  Load a link:formats/GribTables.adoc[GRIB-1 parameter table] (as of version 4.3)
6.  Load a link:formats/GribTables.adoc[GRIB-1 parameter table lookup] (as of version 4.3)
7.  Load a link:formats/GribTables.adoc[GRIB-1 parameter lookup table] (versions < 4.3, deprecated)
8.  Load a link:formats/GribTables.adoc[GRIB-2 parameter lookup table] (versions < 4.3, deprecated)
9.  Load a link:formats/BufrTables.adoc[BUFR table lookup] file
10. Turn link:formats/GribTables.adoc#strict[strict GRIB1 table handling] off.

...
* See <<formats/GribTables.adoc,GribTables>> for more information
...
The file must be a <<formats/BufrTables.adoc,BUFR table lookup file>>.
...
5.  Load a <<formats/GribTables.adoc,GRIB-1 parameter table>> (as of version 4.3)
6.  Load a <<formats/GribTables.adoc,GRIB-1 parameter table lookup>> (as of version 4.3)
7.  Load a <<formats/GribTables.adoc,GRIB-1 parameter lookup table>> (versions < 4.3, deprecated)
8.  Load a <<formats/GribTables.adoc,GRIB-2 parameter lookup table>> (versions < 4.3, deprecated)
9.  Load a <<formats/BufrTables.adoc,BUFR table lookup>> file
10. Turn <<formats/GribTables.adoc#strict,strict GRIB1 table handling>> off.
11. Set the <<netcdf4Clibrary.adoc,netCDF-4 C library>> path and name.

...
4. Download the [`ToolsUI` jar](https://artifacts.unidata.ucar.edu/repository/unidata-all/edu/ucar/toolsUI/5.0.0-WORKSHOP/toolsUI-5.0.0-WORKSHOP.jar) file and start the `TdsMonitor` tool.

...
where:
  ...
  datasetBoundaries.wkt   = the description of the bounding boxes for grid datasets in WKT
  datasetBoundaries.json  = the description of the bounding boxes for grid datasets in GeoJSON

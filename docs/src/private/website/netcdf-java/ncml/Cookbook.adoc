...
<<../reference/Cookbook.adoc#writeClassic,command line copy>>. One can
...
See <<../reference/DatasetUrls.adoc#NcmlScan,Dataset URLS>> for more information on the location attribute.
...
<<Aggregation.adoc#dateFormatMark,dateFormatMark>> attribute. +

...
public class TestGridCoverageWriting {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(new Object[]{TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx3", Lists.newArrayList("Best/Soil_temperature_depth_below_surface_layer"), NetcdfFileWriter.Version.netcdf3});  // TwoD Best
    result.add(new Object[]{TestDir.cdmUnitTestDir + "gribCollections/gfs_2p5deg/gfs_2p5deg.ncx3", Lists.newArrayList("TwoD/Soil_temperature_depth_below_surface_layer"), NetcdfFileWriter.Version.netcdf3 });  // TwoD

...
public class TestGrib1Records {
  ...
  public TestGrib1Records(String ds, int gsdTemplate, int param, long datalen, CalendarDate refdate) {
  ...
  public void testRead() throws IOException {
    readFile(filename, (raf, gr) -> {
      ...
      Assert.assertEquals(gsdTemplate, gds.template);
      Assert.assertTrue(gds.toString().contains("template="+gsdTemplate));

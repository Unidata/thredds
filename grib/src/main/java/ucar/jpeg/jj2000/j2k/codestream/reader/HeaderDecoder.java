...
public class HeaderDecoder implements ProgressionType, Markers,
   ...
   * @throws IOException                  If an I/O error occurs while reading from the
   *                                      encoded header stream.
   * @throws EOFException                 If the end of the encoded header stream is
   *                                      reached before getting all the data.
   * @throws CorruptedCodestreamException If invalid data is found in the
   ...
   * @throws ICCProfileException if image contains a bad icc profile
   * @throws ColorSpaceException if image contains a bad colorspace box
   */

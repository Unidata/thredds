...
* has been reached. */
   ...
   * thrown.
   *
   * @throws IOException If the maximum cache size is reached or if not
   ...
   * is reached.
   *
   * @throws IOException An I/O error occurred, out of meory to grow
   ...
   * @throws EOFException If seeking beyond EOF and the data length is
   *                      known.
   ...
   * @return Always n.
   * @throws EOFException If the end-of file was reached before all the

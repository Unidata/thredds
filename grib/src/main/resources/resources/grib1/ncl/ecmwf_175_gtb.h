 ...
 * Non-ECMWF seasonal forecast model - anomalies
 *
 * Center: 98
 * Subcenter: 0
 * Parameter table version: 175
 */

TBLE2 ecmwf_175_params[] = {
...
{49, "10m wind gust over last 24 hours", "m s**-1", ""},

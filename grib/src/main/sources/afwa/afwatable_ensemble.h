/*
 * parameter table for the Air Force Weather Agency, Joint Ensemble Forecast System
 * center = 57 subcenter = 4
 */

struct ParmTable parm_table_afwa_ensemble[256] = {
   /* 0 */ {"var0", "undefined"},
   /* 1 */ {"PRES", "Pressure [Pa]"},
   ...
   /* 128 */ {"MUPR", "Mean of pressure [Pa]"},
   /* 129 */ {"SIGPR", "Standard deviation of pressure [Pa]"},
   /* 130 */ {"MUMP", "Mean of pressure reduced to MSL [Pa]"},
   /* 131 */ {"SIGMP", "Standard deviation of pressure reduced to MSL [Pa]"},
   /* 132 */ {"MUHT", "Mean of geopotential height [gpm]"},
   /* 133 */ {"SIGHT", "Standard deviation of geopotential height [gpm]"},
   /* 134 */ {"MUT", "Mean of temperature [K]"},
   /* 135 */ {"SIGT", "Standard deviation of temperature [K]"},
   /* 136 */ {"MUU", "Mean of u-component of wind [m/s]"},
   /* 137 */ {"SIGU", "Standard deviation of the u-component of wind [m/s]"},
   /* 138 */ {"MUV", "Mean of v-component of wind [m/s]"},
   /* 139 */ {"SIGV", "Standard deviation of the u-component of wind [m/s]"},
   /* 140 */ {"MUW", "Mean of w-component of wind [m/s]"},
   /* 141 */ {"SIGW", "Standard deviation of the w-component of wind [m/s]"},
   /* 142 */ {"RHOUV", "UV wind components correlation coefficient [non-dim]"},
   /* 143 */ {"MUDP", "Mean of dewpoint temperature [K]"},
   /* 144 */ {"SIGDP", "Standard deviation of dewpoint temperature [K]"},
   /* 145 */ {"AGPCP", "Alpha Gamma distribution parameter, accum. precipitation [non-dim]"},
   /* 146 */ {"BGPCP", "Beta Gamma distribution parameter, accum. precipitation [kg/m^2]"},
   /* 147 */ {"AGSNW", "Alpha Gamma distribution parameter, accum. snow [non-dim]"},
   /* 148 */ {"BGSNW", "Beta Gamma distribution parameter, accum. snow [m]"},
   ...
   /* 200 */ {"PWS25", "Probability of windspeeds greater than 25kts [%]"},
   /* 201 */ {"PWS35", "Probability of windspeeds greater than 35kts [%]"},
   /* 202 */ {"PWS50", "Probability of windspeeds greater than 50kts [%]"},
   /* 203 */ {"PTLGT", "Probability of light turbulence [%]"},
   /* 204 */ {"PTMDT", "Probability of moderate turbulence [%]"},
   /* 205 */ {"PTSVR", "Probability of severe turbulence [%]"},
   /* 206 */ {"PQP6", "Probability of 6-hr precipitation greater than 0.01in [%]"},
   /* 207 */ {"PQP12", "Probability of 12-hr precipitation greater than 2.0in [%]"},
   /* 208 */ {"PSN6", "Probability of 6-hr snow accumulation greater than 0.1in [%]"},
   /* 209 */ {"PSN12", "Probability of 12-hr snow accumulation greater than 2.0in [%]"},
   /* 210 */ {"PFZR", "Probability of freezing rain [%]"},
   /* 211 */ {"PILGT", "Probability of light icing [%]"},
   /* 212 */ {"PIMDT", "Probability of moderate icing [%]"},
   /* 213 */ {"PISVR", "Probability of severe icing [%]"},
   /* 214 */ {"PTS", "Probability of thunderstorm [%]"},
   /* 215 */ {"PSTS", "Probability of severe thunderstorm [%]"},
   /* 216 */ {"PHSTR", "Probability of heat index greater than 95 deg F [%]"},
   /* 217 */ {"PWCH", "Probability of wind chill less than -10 deg F [%]"},
   /* 218 */ {"PMVFR", "Probability of marginal VFR conditions [%]"},
   /* 219 */ {"PIFR", "Probability of IFR conditions [%]"},

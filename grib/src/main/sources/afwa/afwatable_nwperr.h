 ...
 * center = 57 subcenter = 11
 */

struct ParmTable parm_table_afwa_nwperr[256] = {
   /* 0 */ {"var0", "undefined"},
   /* 1 */ {"PRES", "Pressure [Pa]"},
   ...
   /* 128 */ {" var128", " blank [n/a]"},
   /* 129 */ {" var129", " blank [n/a]"},
   ...
   /* 156 */ {" var155", " blank [n/a]"},
   /* 157 */ {" var155", " blank [n/a]"},
   ...
   /* 200 */ {" TPERR", " Temperature Error Estimate [deg K] "},
   /* 201 */ {" MRERR", " Mixing Ratio Error Estimate  [kg kg-1] "},

 ...
 */
public class NC_TimePeriodTypeTest {
    @Test public void testCreateTimePeriod() throws Exception {
        ...
        try {
            ...
            JAXBElement<?> jaxbElement = Factories.GML.createTimePeriod(timePeriod);

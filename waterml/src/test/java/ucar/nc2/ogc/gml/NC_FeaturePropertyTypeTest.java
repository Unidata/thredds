 ...
 */
public class NC_FeaturePropertyTypeTest {
    @Test public void testCreateFeatureOfInterest() throws Exception {
        ...
        try {
            ...
            FeaturePropertyType featPropType = NC_FeaturePropertyType.createFeatureOfInterest(stationFeat);
            JAXBElement<?> jaxbElement = Factories.GML.createFeatureProperty(featPropType);

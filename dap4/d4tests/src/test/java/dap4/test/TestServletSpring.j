...
import dap4.test.util.UnitTestCommon;                                                                     b
...
@ContextConfiguration(locations={"/WEB-INF/applicationContext-dap4Config.xml"}, loader=MockTdsContextLoader.class)

public class TestServletSpring extends UnitTestCommon
{
    ...
    protected D4TSServlet d4tsservlet;
    protected String path = "/thredds/dodsC/gribCollection/GFS_CONUS_80km/files/GFS_CONUS_80km_20120229_1200.grib1.ascii";
    ...
    public TestServletSpring()
        throws Exception
    {
        this("TestServlet");
    }

    public TestServletSpring(String name)
        throws Exception
    {
        this(name, null);
    }

    public TestServletSpring(String name, String[] argv)
        throws Exception
    {
        super(name);
        setSystemProperties();
...
*/
    ...
    public void setUp() throws Exception {
        d4tsservlet = new D4TSServlet();
        d4tsservlet.init(servletConfig);
        d4tsservlet.init();
    }
        ...
        throws Exception
    {
        ...
        String mockURI = testcase.makeurl(RequestMode.DMR);
        MockHttpServletRequest request = new MockHttpServletRequest("GET", mockURI);      
        //request.setContextPath("/thredds");
        request.setPathInfo(this.datasetpath);
        MockHttpServletResponse response = new MockHttpServletResponse();

        try {
	    d4tsservlet.doGet(request, response);
        } catch (Throwable t) {
        ...
        byte[] byteresult = response.getContentAsByteArray();
        ...
        throws Exception
    {
        ...
        String mockURI = testcase.makeurl(RequestMode.DAP);
        MockHttpServletRequest request = new MockHttpServletRequest("GET", mockURI);      
        //request.setContextPath("/thredds");
        request.setPathInfo(this.datasetpath);
        MockHttpServletResponse response = new MockHttpServletResponse();

...
public class TimeStationObs {
  ...
  public void timeNetcdf() throws IOException {
    ...
    System.out.println("\ntimeNetcdf successfully read " + limit.count + " records; found " + limit.matches + " matches");
  ...
  public void writeXML() throws IOException {
    ...
    long took = System.currentTimeMillis() - start;
    double mps = 1000 * limit.count / took;
    System.out.println("\nwriteXML successfully read " + limit.count + " records; found " + limit.matches + " matches");
    System.out.println("that took = " + took + " msecs; messages/sec = " + mps);
  }
  ...
  public void writeRaw() throws IOException {
    ...
    long took = System.currentTimeMillis() - start;
    double mps = 1000 * limit.count / took;
    System.out.println("\nwriteRaw successfully read " + limit.count + " records; found " + limit.matches + " matches");
    System.out.println("that took = " + took + " msecs; messages/sec = " + mps);
  }

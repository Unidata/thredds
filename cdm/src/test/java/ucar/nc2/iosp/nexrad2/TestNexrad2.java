...
public class TestNexrad2 extends TestCase {
  ...
  public void testRead() throws IOException {
    ...
    doDirectory(TestAll.getUpcSharePath() + "/testdata/radar/nexrad/level2/VCP11", false);
  ...
  public void utestCoordSys() throws IOException {
    ...
    String filename = TestAll.getUpcSharePath() + "/testdata/radar/nexrad/level2/Level2_KYUX_20060527_2335.ar2v";
  ...
  public void testBzipProblem() throws IOException, InvalidRangeException {
    ...
    String filename = TestAll.getUpcSharePath() + "/testdata/radar/nexrad/level2/Level2_KFTG_20060818_1814.ar2v.uncompress.missingradials";

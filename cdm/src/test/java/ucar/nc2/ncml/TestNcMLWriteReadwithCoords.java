...
public class TestNcMLWriteReadwithCoords extends TestCase {
  static boolean showFiles = true, showCompare = false, showEach = false;

  public TestNcMLWriteReadwithCoords( String name) {
    super(name);
  }
  ...
  public void setUp() {
    ...
    files.add( TestAll.testdataDir+"radar/nexrad/level2/6500KHGX20000610_000110.Z"); // */
    files.add( TestAll.testdataDir+"radar/nexrad/level2/KPUX_20041020_1344"); // craft */
  }


  public void utestReadAsNcdataset() throws Exception {
  ...
  public void testOne() throws Exception  {
    convertAsNcdataset( "C:/data/conventions/nuwg/ocean.nc");
    convertAsNcdataset( "C:/data/conventions/nuwg/ocean.nc");
  }

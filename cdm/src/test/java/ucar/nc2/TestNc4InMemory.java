...
public class TestNc4InMemory extends UnitTestCommon
{
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

    public TestNc4InMemory(String name) {
        super(name);
    }

    private NetcdfFile openInMemory(String filename)
            throws IOException
    {
    ...
    @Test
    public void testNc4Direct()
            throws IOException {
    }

    @Test
    public void testOpen_mem()
            throws IOException {

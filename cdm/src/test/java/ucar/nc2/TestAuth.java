...
import ucar.nc2.util.net.HTTPCreds;
...
// Define the test sets
    ...
    testBasic() throws Exception
    {
        ...
        creds.schemeHttpBasic(provider);
        HTTPAuthStore.insert(user, url, HTTPAuthStore.Scheme.BASIC, creds);

        HTTPSession.setGlobalPrincipal(user);

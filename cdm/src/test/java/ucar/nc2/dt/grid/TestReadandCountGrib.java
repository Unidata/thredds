...
public class TestReadandCountGrib extends TestCase {
  ...
  public void testRead() throws Exception {
    ...
    doOne("grib1/data/","ecmf.wmo", 56, 44, 116, 58); // was 112, 56
    ...
    doOne("grib1/data/","thin.wmo", 240, 87, 117, 63); // was 88, 120, 64  // */
    doOne("grib1/data/","ukm.wmo", 96, 49, 69, 32);  // 67, 32
    ...
    doOne("grib2/data/","eta2.wmo", 35, 8, 10, 6);
    doOne("grib2/data/","ndfd.wmo", 1, 1, 3, 0);
    doOne("grib2/data/","eta218.wmo", 57, 14, 19, 10);

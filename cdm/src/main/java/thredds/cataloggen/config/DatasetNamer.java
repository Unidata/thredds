// $Id: DatasetNamer.java,v 1.9 2006/01/20 02:08:23 caron Exp $
...
public class DatasetNamer
{
   ...
   */
  public boolean getAddLevel() { return( this.addLevel); }

  /**
   * Set the value of the addLevel attribute
   * @param addLevel
   */
  public void setAddLevel( boolean addLevel) { this.addLevel = addLevel; }

  /**
   * Return the type attribute of this DatasetNamer.
   * @return DatasetNamerType type value for this DatasetNamer
   */
  public DatasetNamerType getType() { return( this.type); }
   ...
   */
  public void setType( DatasetNamerType type) { this.type = type; }
   ...
   * @param attName
   */
  public void setAttribName( String attName) { this.attribName = attName; }
...
//    throws java.lang.Exception
  {
    ...
    catch ( DODSException e) // DODSException and DASException
    {
    ...
    //-----
    AttributeTable dodsAttTable
      = das.getAttributeTable( this.attribContainer);
    if ( dodsAttTable != null)
    {
      ...
      if ( desiredAtt.getType() == dods.dap.Attribute.STRING)
      {

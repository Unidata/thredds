...
public class IO {
  ...
  static public void main(String[] args) {
    String url = "http://motherlode.ucar.edu:9080/thredds/ncss/metars?variables=all&spatial=all&time_start=2007-09-24T00%3A00%3A00Z&time_end=2007-09-24T23%3A59%3A59Z&accept=xml";

    String filenameOut = "C:/temp/metars1day.xml";
    File f = new File(filenameOut);

// $Id: SI.java,v 1.5 2000/08/18 04:17:31 russ Exp $
/*
 ...
 * @version $Id: SI.java,v 1.5 2000/08/18 04:17:31 russ Exp $
 */
public final class
SI
    extends	UnitSystemImpl
{
	...
	try
	{
	    ...
	    steradian	= bu("steradian", "sr",  BaseQuantity.SOLID_ANGLE);
            ...
            liter           = du("liter", "L", new ScaledUnit(1e-3, (UnitImpl)meter.raiseTo(3)));
		// exact. However, from 1901 to 1964, 1 liter = 1.000028 dm3
            ...
            barn            = du("barn", "b", new ScaledUnit(1e-28, (UnitImpl)meter.raiseTo(2)));

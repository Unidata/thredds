// $Id: ArrayInt.java,v 1.5 2005/05/11 00:09:53 caron Exp $
/*
...
public class ArrayInt extends Array {
  ...
  static ArrayInt factory( Index index, int [] storage) {
    switch (index.getRank()) {
      case 0 : return new ArrayInt.D0(index, storage);
      case 1 : return new ArrayInt.D1(index, storage);
      case 2 : return new ArrayInt.D2(index, storage);
      case 3 : return new ArrayInt.D3(index, storage);
      case 4 : return new ArrayInt.D4(index, storage);
      case 5 : return new ArrayInt.D5(index, storage);
      case 6 : return new ArrayInt.D6(index, storage);
      case 7 : return new ArrayInt.D7(index, storage);
      default : return new ArrayInt(index, storage);
    }
  }
  ...
  */
  ...
  Array createView( Index index) {
    return ArrayInt.factory( index, storage);
  }
 ...
 /** Return the element class type */
  public Class getElementType() { return int.class; }
  ...
  public void setDouble(int[] index, double value) {
    storage[indexCalc.element(index)] = (int) value;
  } */
  ...
  public Object getObject(int [] index) {
    return new Integer(storage[indexCalc.element(index)]);
  }
  public void setObject(int [] index, Object value) {
    storage[indexCalc.element(index)] = ((Number)value).intValue();
  } */
  public Object getObject(Index i) {
    return new Integer(storage[i.currentElement()]);
  }
  ...
  void setDouble(int index, double value) { storage[index] = (int) value; }

  float getFloat(int index) { return storage[index]; }
  void setFloat(int index, float value) { storage[index] = (int) value;}

  long getLong(int index) {return (long) storage[index];}
  void setLong(int index, long value) { storage[index] = (int) value;}

  int getInt(int index) { return (int) storage[index]; }
  void setInt(int index, int value) { storage[index] = (int) value;}

  short getShort(int index) { return (short) storage[index]; }
  void setShort(int index, short value) { storage[index] = (int) value; }

  byte getByte(int index) { return (byte) storage[index]; }
  void setByte(int index, byte value) {storage[index] = (int) value;}

  char getChar(int index) { return (char) storage[index];}
  void setChar(int index, char value) { storage[index] = (int) value; }
  ...
  Object getObject(int index) { return new Integer( getInt( index)); }
  void setObject(int index, Object value) { storage[index] = ((Number)value).intValue(); }
...
/* Change History:
   ...
   Revision 1.4  2005/02/22 22:12:12  caron
   *** empty log message ***

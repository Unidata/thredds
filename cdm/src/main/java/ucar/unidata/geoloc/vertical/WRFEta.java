...
public class WRFEta extends VerticalTransformImpl {
    ...
    public WRFEta(NetcdfDataset ds, Dimension timeDim, VerticalCT vCT) {
        ...
        isXStag = (param != null)
                  && Boolean.valueOf(param.getStringValue()).booleanValue();
        ...
        if (isZStag) {
            ...
            pertVarName = vCT.findParameterIgnoreCase(
                PerturbationGeopotentialVariable).getStringValue();
            baseVarName = vCT.findParameterIgnoreCase(
                BaseGeopotentialVariable).getStringValue();
            ...
            pertVarName = vCT.findParameterIgnoreCase(
                PerturbationPressureVariable).getStringValue();
            baseVarName = vCT.findParameterIgnoreCase(
                BasePressureVariable).getStringValue();

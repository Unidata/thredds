 ...
 *
 * @version $Id: Gdc_To_Utm_Converter.java,v 1.4 2006/11/18 19:03:22 dmurray Exp $
 */
...
class Gdc_To_Utm_Converter {
    ...
    /** _more_ */
    private double A, F, C, Eps2, Eps25, Epps2,
     ...
     */
    public Gdc_To_Utm_Converter(double a, double f, int zone,
     ...
     */
    public Gdc_To_Utm_Converter(EarthEllipsoid ellipse, int zone,
                                boolean isNorth) {
        init(ellipse.getMajor(), ellipse.getFlattening(), zone, isNorth);
    }
    ...
    protected void init(double a, double f, int zone, boolean isNorth) {
        ...
        polx3b = 1.0 * Math.pow(Eps2, 2) + 3.0 / 4.0 * Math.pow(Eps2, 3)

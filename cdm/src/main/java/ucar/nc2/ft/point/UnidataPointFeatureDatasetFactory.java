...
public class UnidataPointFeatureDatasetFactory implements FeatureDatasetFactory {
  ...
  private static class UnidataPointFeatureDataset extends PointDatasetImpl {
    ...
    private UnidataPointFeatureDataset(NetcdfDataset ds, Formatter errlog) throws IOException {
  ...
  public static void main(String args[]) throws IOException {
    ...
    UnidataPointFeatureDataset upod = new UnidataPointFeatureDataset(NetcdfDataset.openDataset(filename), new Formatter());
    System.out.println("\n\n");

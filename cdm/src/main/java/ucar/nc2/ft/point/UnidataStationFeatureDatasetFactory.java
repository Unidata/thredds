...
public class UnidataStationFeatureDatasetFactory implements FeatureDatasetFactory {
  ...
  private static class UnidataStationFeatureDataset extends PointDatasetImpl {
   ...
   LatLonRect getFilterBB() {
    ...
    public UnidataStationFeatureDataset(NetcdfDataset ds, Formatter errlog) throws IOException {
  ...
  public DataCost getDataCost() {
    ...
    private class UnidataStation extends StationFeatureImpl {
      ...
      private UnidataStation(String name, String desc, double lat, double lon, double elev, int firstRecord, int count) {
        super(name, desc, lat, lon, elev, recordHelper.getTimeUnit(), count);
  ...
  public static void main(String args[]) throws IOException {
    ...
    UnidataStationFeatureDataset ods = new UnidataStationFeatureDataset(NetcdfDataset.openDataset(filename), new Formatter());

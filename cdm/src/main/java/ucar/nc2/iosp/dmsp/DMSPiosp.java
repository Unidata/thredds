...
/*
 * $Log: DMSPiosp.java,v $
 * Revision 1.20  2006/05/31 19:04:41  edavis
 ...
 *
 * Revision 1.19  2006/04/03 22:59:18  caron
 ...
 *
 * Revision 1.18  2006/01/17 23:07:13  caron
 * *** empty log message ***
 *
 * Revision 1.17  2006/01/04 00:02:30  caron
 ...
 * use jdom 1.0
 *
 * Revision 1.16  2005/12/15 00:29:11  caron
 * *** empty log message ***
 *
 * Revision 1.15  2005/12/09 04:24:37  caron
 * Aggregation
 * caching
 * sync
 *
 * Revision 1.14  2005/07/25 22:20:05  caron
 * add iosp.synch()
 *
 * Revision 1.13  2005/06/11 18:41:59  caron
 * no message
 *
 * Revision 1.12  2005/05/23 21:52:55  caron
 * add getDetailInfo() to IOSP for error/debug info
 *
 * Revision 1.11  2005/05/11 00:10:03  caron
 * refactor StuctureData, dt.point
 *
 * Revision 1.10  2005/01/14 22:04:55  edavis
 * Add some comments to EllipsoidalEarthModel class.
 *
 * Revision 1.9  2004/12/09 00:11:05  edavis
 * More fixes for _Coordinates convention.
 *
 * Revision 1.8  2004/12/07 23:44:45  edavis
 * Fix _CoordinateAxisType attribute name.
 *
 * Revision 1.7  2004/12/07 23:27:09  edavis
 * Add a time variable and various global and variable attributes to comply with the "_Coordinates" convention.
 *
 * Revision 1.6  2004/12/03 21:04:14  edavis
 * Added some comments to class.
 *
 * Revision 1.5  2004/10/14 19:40:27  edavis
 * Added comments on earth ellipsoid used to geolocate pixesls. Also added attribute on how geolocation was calculated.
 *
 * Revision 1.4  2004/10/13 15:28:12  edavis
 * Clean up some variable attributes and add "_unsigned" attribute to visibleScan and thermalScan variables.
 *
 * Revision 1.3  2004/10/08 20:02:27  edavis
 * Fix a few bugs in geolocation calculations and indexing while reading 2-D array into 1-D array.
 *
 * Revision 1.2  2004/10/06 21:35:36  edavis
 * 1) Cache data for more variables (satEphemLatitude, satEphemLongitude, satEphemAltitude, satEphemHeading, scannerOffset, and scanDirection).
 * 2) Add calculation of satellite epoch information but comment out for now.
 * 3) Add calculation of geolocated latitude and longitude of each pixel.
 * 4) Add static classes for geolocation of swath data (GeolocateOLS, OLSSensorModel, EllipsoidalEarthModel, and VectorMath).
 *

...
/* Change History:
   $Log: H5header.java,v $
   Revision 1.17  2006/03/28 19:57:02  caron
   remove DateUnit static methods - not thread safe
   bugs in ForecasstModelRun interactions with external indexer

   Revision 1.16  2005/07/11 20:12:22  caron
   *** empty log message ***

   Revision 1.15  2005/07/01 03:39:06  caron
   limit how far into file to look for header, to speed up large files

   Revision 1.14  2005/05/11 00:09:55  caron
   refactor StuctureData, dt.point

   Revision 1.13  2005/01/12 01:24:14  caron
   check attribute names valid

   Revision 1.12  2004/12/07 02:43:20  caron
   *** empty log message ***

   Revision 1.11  2004/12/07 01:29:32  caron
   redo convention parsing, use _Coordinate encoding.

   Revision 1.10  2004/11/21 01:16:48  caron
   ncml pass 1

   Revision 1.9  2004/09/22 18:44:31  caron
   move common to ucar.unidata

   Revision 1.8  2004/09/22 13:46:34  caron
   *** empty log message ***

   Revision 1.7  2004/09/09 22:47:39  caron
   station updates

   Revision 1.6  2004/08/19 20:51:12  edavis
   Rename NetcdfFile.mungeName( String) to NetcdfFile.createValidNetcdfObjectName( String) and change from protected to public.

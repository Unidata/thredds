 ...
 */
    ...
    public class TDSRadarDatasetCollection extends StationRadarCollectionImpl {
      //////////////////////////////////////////////////////////////////////////////////
        ...
        private TDSRadarDatasetCollection(String desc, String dsc_location, Element elem, Namespace ns, StringBuffer errlog)
                throws IOException{
            super();
            ...
            this.endDate   = DateUnit.getStandardOrISO((String)radarTimeSpan.get(0));
        ...
        private StationImpl readStation(Element elem) {
            ...
            StationImpl station =
                    new StationImpl(name, descv, Double.valueOf(latv), Double.valueOf(lonv), Double.valueOf(altv));
         ...
         * @throws IOException java io exception
         */
        public RadialDatasetSweep getRadarDataset(String stnName, String productID, Date absTime)
                throws IOException {
            // absTime is a member of  datasetsDateURI
            // long start = System.currentTimeMillis();
         ...
         * @throws IOException java io exception
         */
        private TDSRadarDatasetInfo queryRadarStation(String stnName, String productID, Date start,
                Date end)
                throws IOException {
            // http://motherlode.ucar.edu:9080/thredds/idd/radarLevel2?returns=catalog&stn=KFTG&dtime=latest
            StringBuffer queryb = new StringBuffer();
         ...
         * @throws IOException java io exception
         */
        public ArrayList getRadarStationTimes(String stnName, String productID, Date start,
                                              Date end)
                throws IOException {
        ...
        public static void main(String args[]) throws IOException {
            ...
            TDSRadarDatasetCollection dsc = TDSRadarDatasetCollection.factory("test", ds_location, errlog);

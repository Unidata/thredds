// $Id: Group.java,v 1.13 2006/02/13 19:51:24 caron Exp $
/*
 ...
 *
 * @author caron
 * @version $Revision: 1.13 $ $Date: 2006/02/13 19:51:24 $
 */
public class Group {
...
/* Change History:
   $Log: Group.java,v $
   Revision 1.13  2006/02/13 19:51:24  caron
   javadoc

   Revision 1.12  2005/07/25 16:12:12  caron
   cleanup unit testing
   NetcdfDataset does not modify wrapped NetcdfFile, allowing it to be acquired

   Revision 1.11  2005/05/16 16:02:30  edavis
   Fix some checks for null parameters.
   ...
   Revision 1.7  2004/10/13 19:45:13  caron
   add strict NCDump

   Revision 1.6  2004/10/06 19:03:44  caron
   clean up javadoc
   change useV3 -> useRecordsAsStructure
   remove id, title, from NetcdfFile constructors
   add "in memory" NetcdfFile

   Revision 1.5  2004/10/02 20:58:29  caron
   add findVariableRecurse

   Revision 1.4  2004/09/22 13:46:34  caron
   *** empty log message ***

   Revision 1.3  2004/08/19 20:49:16  edavis
   Make public a number of methods for building an Group.

   Revision 1.2  2004/08/16 20:53:44  caron
   2.2 alpha (2)

   Revision 1.1  2004/07/06 19:28:09  caron
   pre-alpha checkin

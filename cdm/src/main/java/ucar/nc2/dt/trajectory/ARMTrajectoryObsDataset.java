// $Id: ARMTrajectoryObsDataset.java,v 1.4 2006/02/09 22:57:11 edavis Exp $
...
/*
 * $Log: ARMTrajectoryObsDataset.java,v $
 * Revision 1.4  2006/02/09 22:57:11  edavis
 * Add syncExtend() method to TrajectoryObsDataset.
 *
 * Revision 1.3  2005/10/11 22:51:17  edavis
 * Fix to handle newer ARM data.
 *
 * Revision 1.2  2005/05/23 17:02:22  edavis
 * Deal with converting elevation data into "meters".
 *
 * Revision 1.1  2005/05/16 23:49:54  edavis
 * Add ucar.nc2.dt.trajectory.ARMTrajectoryObsDataset to handle
 * ARM sounding files. Plus a few other fixes and updates to the
 * tests.
 *
 * Revision 1.1  2005/05/16 18:26:37  edavis

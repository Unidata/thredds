 ...
 * @author caron
 */
public class NetcdfFileCacheOld {
  static private org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(NetcdfFileCacheOld.class);
  // LOOK: May switch to CopyOnWriteArrayList when we get to 1.5
  static private ArrayList<CacheElement> cache; // CacheElement
